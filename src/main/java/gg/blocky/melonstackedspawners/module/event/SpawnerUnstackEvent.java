...
@Getter
public final class SpawnerUnstackEvent extends Event {

	private static final HandlerList handlers = new HandlerList();

	private final Player player;
	private final StackedSpawner stackedSpawner;
	private final int previousStackAmount, stackAmount;

	public SpawnerUnstackEvent(Player player, StackedSpawner stackedSpawner, int previousStackAmount, int stackAmount) {
		this.player = player;
		this.stackedSpawner = stackedSpawner;
		this.previousStackAmount = previousStackAmount;
