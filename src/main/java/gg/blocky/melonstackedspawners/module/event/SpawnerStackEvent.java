...
@Getter
public final class SpawnerStackEvent extends Event {
	...
	public SpawnerStackEvent(Player player, StackedSpawner stackedSpawner, int previousStackAmount, int stackAmount) {
		this.player = player;
