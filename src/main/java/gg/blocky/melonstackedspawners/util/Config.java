...
public class Config {
	...
	private static final Logger LOGGER = SpawnerPlugin.getInstance().getLogger();
	...
	private void set(String key, Object value, Class<?> root) {
		...
		LOGGER.log(Level.INFO, "Failed to set config option: " + key + ": " + value + " | " + instance + " | " + root.getSimpleName() + ".yml");
	}
